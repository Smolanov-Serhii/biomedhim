	...
	<header id="header" class="header">
        <div class="header__undernav">
            <div class="bio-container">
                ...
                <span>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 4.5C5.20435 4.5 4.44129 4.81607 3.87868 5.37868C3.31607 5.94129 3 6.70435 3 7.5V7.8015L12 12.648L21 7.803V7.5C21 6.70435 20.6839 5.94129 20.1213 5.37868C19.5587 4.81607 18.7956 4.5 18 4.5H6Z" fill="white"/>
                    <path d="M21 9.50537L12.3555 14.1599C12.2462 14.2187 12.1241 14.2495 12 14.2495C11.8759 14.2495 11.7538 14.2187 11.6445 14.1599L3 9.50537V16.4999C3 17.2955 3.31607 18.0586 3.87868 18.6212C4.44129 19.1838 5.20435 19.4999 6 19.4999H18C18.7956 19.4999 19.5587 19.1838 20.1213 18.6212C20.6839 18.0586 21 17.2955 21 16.4999V9.50537Z" fill="white"/>
                    </svg>
                </span>
            ...
            <div class="header__woo">
                ...
                if (class_exists('WooCommerce' )){
                    ...
                    <a href="<?php echo $woocommerce->cart->get_cart_url() ?>" class="fix_cart_btn fz_an">
                        ...
                        ?>
                        <span class="fix_cart_total"><?php echo sprintf($woocommerce->cart->cart_contents_total); echo $currency_symbol;?></span>
                    </a>
                    <?php
                }
                ?>
