...
<head>
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/73513231" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
</head>
...
<div class="mobile-nav" style="display: none">
    <div class="mobile-nav__close">
        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.307617" y="16.2637" width="23" height="3" transform="rotate(-45 0.307617 16.2637)" fill="#4BC3E8"/>
            <rect x="2.42896" width="23" height="3" transform="rotate(45 2.42896 0)" fill="#4BC3E8"/>
        </svg>
    </div>
        ...
        <a href="<?php echo get_home_url(); ?>" class="custom-logo-link">
            <picture>
                <source media="(max-width: 768px)"
                        srcset="<?php echo get_template_directory_uri() . '/images/logo-mobile.svg'?>">
                <img src="<?php echo get_template_directory_uri() . '/images/logo-pc.svg'?>" alt="Биомедхим">
            </picture>
        </a>
